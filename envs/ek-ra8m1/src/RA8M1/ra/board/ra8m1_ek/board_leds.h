...
typedef struct st_bsp_leds {
  ...
  uint16_t const
      *p_leds;  ///< Pointer to an array of IOPORT pins for controlling LEDs
} bsp_leds_t;

/** Available user-controllable LEDs on this board. These enums can be can be
 * used to index into the array of LED pins found in the bsp_leds_t structure.
 */
