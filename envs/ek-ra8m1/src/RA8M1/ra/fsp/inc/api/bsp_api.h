...
/* Store warning settings for 'conversion' and 'sign-conversion' to as specified
 * on command line. */
#pragma GCC diagnostic push

/* CMSIS-CORE currently generates 2 warnings when compiling with GCC. One in
 * core_cmInstr.h and one in core_cm4_simd.h. We are not modifying these files
 * so we will ignore these warnings temporarily. */
...
/* CMSIS-CORE Renesas Device Files. Must come after bsp_feature.h, which is
 * included in bsp_cfg.h. */
#include "../../src/bsp/cmsis/Device/RENESAS/Include/renesas.h"
#include "../../src/bsp/cmsis/Device/RENESAS/Include/system.h"

#if defined(__GNUC__) && !defined(__ARMCC_VERSION)

/* Restore warning settings for 'conversion' and 'sign-conversion' to as
