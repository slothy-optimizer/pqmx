...
/* Workaround for LLVM. __ARM_ARCH_8_1M_MAIN__ is defined for CM85 parts. But
 * CMSIS_5 does not support this */
...
/* Workaround for compilers that are not defining __ARM_ARCH_8_1M_MAIN__ for
 * CM85 parts. Search CM85_WORKAROUND for related code changes */
...
/* ===========================================================================================================================
 */
/* IRQn_Type is provided in bsp_exceptions.h. Vectors generated by the FSP
 * Configuration tool are in vector_data.h */
