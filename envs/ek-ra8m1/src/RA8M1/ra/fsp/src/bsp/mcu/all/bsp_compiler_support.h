...
/* The AC6 linker requires uninitialized code to be placed in a section that
 * starts with ".bss." Without this, load memory (ROM) is reserved
 * unnecessarily. */
...
/** Stacks (and heap) must be sized and aligned to an integer multiple of this
 * number. */
