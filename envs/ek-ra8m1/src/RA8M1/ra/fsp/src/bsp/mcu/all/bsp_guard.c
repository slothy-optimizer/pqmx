...
/*******************************************************************************************************************/ /**
                                                                                                                       ...
                                                                                                                       **********************************************************************************************************************/
BSP_CMSE_NONSECURE_ENTRY fsp_err_t R_BSP_ClockUpdateCallbackSet(
  ...
  bsp_clock_update_callback_t p_callback_checked =
      (bsp_clock_update_callback_t)cmse_check_address_range(
          (void *)p_callback, sizeof(void *), CMSE_AU_NONSECURE);

  bsp_clock_update_callback_args_t *p_callback_memory_checked =
      (bsp_clock_update_callback_args_t *)cmse_check_address_range(
          p_callback_memory, sizeof(bsp_clock_update_callback_args_t),
          CMSE_AU_NONSECURE);
  FSP_ASSERT(p_callback == p_callback_checked);
  FSP_ASSERT(p_callback_memory == p_callback_memory_checked);

  r_bsp_clock_update_callback_set(p_callback_checked,
                                  p_callback_memory_checked);
