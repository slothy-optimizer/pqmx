...
#define BSP_MSTP_BIT_FSP_IP_GPT(channel)                            \
  ((BSP_FEATURE_BSP_MSTP_GPT_MSTPD5_MAX_CH >= channel) ? (1U << 5U) \
                                                       : (1U << 6U));
 ...
 */
#define BSP_MSTP_BIT_FSP_IP_AGT(channel)                                    \
  (1U << ((channel < BSP_FEATURE_AGT_AGTW_CHANNEL_COUNT)                    \
              ...
              : ((channel < BSP_FEATURE_AGT_AGTW_CHANNEL_COUNT + 2U)        \
                     ...
                     : ((channel < BSP_FEATURE_AGT_AGTW_CHANNEL_COUNT + 4U) \
                            ? (1U - channel +                               \
                               BSP_FEATURE_AGT_AGTW_CHANNEL_COUNT + 2U)     \
                            : (10U - channel +                              \
                               BSP_FEATURE_AGT_AGTW_CHANNEL_COUNT + 4U)))));
...
#define BSP_MSTP_BIT_FSP_IP_GPT(channel) (1U << (31 - channel));
#define BSP_MSTP_REG_TYPE_FSP_IP_GPT(channel) uint32_t
#define BSP_MSTP_REG_FSP_IP_AGT(channel) \
  *((3U >= channel) ? &R_MSTP->MSTPCRD : &R_MSTP->MSTPCRE)
#define BSP_MSTP_BIT_FSP_IP_AGT(channel) \
  ((3U >= channel) ? (1U << (3U - channel)) : (1U << (15U - (channel - 4U))));
#define BSP_MSTP_REG_TYPE_FSP_IP_AGT(channel) uint32_t
#define BSP_MSTP_REG_FSP_IP_KEY(channel) R_MSTP->MSTPCRE
...
#define BSP_MSTP_BIT_FSP_IP_I3C(channel) \
  (1U << (BSP_FEATURE_I3C_MSTP_OFFSET - channel));
