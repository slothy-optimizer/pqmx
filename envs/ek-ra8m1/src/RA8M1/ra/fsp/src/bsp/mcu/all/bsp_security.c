...
/* Non-secure regions defined by the IDAU. These regions must be defined as
 * non-secure in the SAU. */
...
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_flash =
    (uint32_t *)__section_begin(".tz_flash_ns_start");
#pragma section = "Veneer$$CMSE"
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_callable_flash =
    (uint32_t *)__section_begin("Veneer$$CMSE");
#pragma section = ".tz_ram_ns_start"
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_ram =
    (uint32_t *)__section_begin(".tz_ram_ns_start");
#pragma section = ".tz_ram_nsc_start"
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_callable_ram =
    (uint32_t *)__section_begin(".tz_ram_nsc_start");
#pragma section = ".tz_data_flash_ns_start"
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_data_flash =
    (uint32_t *)__section_begin(".tz_data_flash_ns_start");
...
#if BSP_FEATURE_BSP_HAS_ITCM
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_itcm =
    (uint32_t *)&__tz_ITCM_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_itcm =
    (uint32_t *)&__tz_ITCM_S;
#endif

#if BSP_FEATURE_BSP_HAS_DTCM
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_dtcm =
    (uint32_t *)&__tz_DTCM_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_dtcm =
    (uint32_t *)&__tz_DTCM_S;
#endif
...
/* Assign region addresses to pointers so that AC6 includes symbols that can be
 * used to determine the start addresses of Secure, Non-secure and Non-secure
 * Callable regions. */
#if BSP_FEATURE_BSP_HAS_ITCM
...
#endif
#if BSP_FEATURE_BSP_HAS_STBRAMSABAR
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_standby_sram =
    &__tz_STANDBY_SRAM_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_standby_sram =
    &__tz_STANDBY_SRAM_S;
#endif
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_flash =
    &__tz_FLASH_N;
...
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_data_flash =
    &__tz_DATA_FLASH_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_data_flash =
    &__tz_DATA_FLASH_S;

#if BSP_TZ_SECURE_BUILD

BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_qspi_flash =
    &__tz_QSPI_FLASH_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_qspi_flash =
    &__tz_QSPI_FLASH_S;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_sdram =
    &__tz_SDRAM_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_sdram = &__tz_SDRAM_S;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_ospi_device_0 =
    &__tz_OSPI_DEVICE_0_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_ospi_device_0 =
    &__tz_OSPI_DEVICE_0_S;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_ospi_device_1 =
    &__tz_OSPI_DEVICE_1_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_ospi_device_1 =
    &__tz_OSPI_DEVICE_1_S;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_option_setting =
    &__tz_OPTION_SETTING_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_option_setting =
    &__tz_OPTION_SETTING_S;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_option_setting_s =
    &__tz_OPTION_SETTING_S_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_option_setting_s =
    &__tz_OPTION_SETTING_S_S;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_id_code =
    &__tz_ID_CODE_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_secure_id_code =
    &__tz_ID_CODE_S;
...
#else
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_flash =
    &FLASH_NS_IMAGE_START;
#endif
#if BSP_FEATURE_TZ_VERSION == 2
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_callable_flash =
    (uint32_t *)&__FLASH_NSC_START;
#else
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_callable_flash =
    (uint32_t *)&__tz_FLASH_C;
#endif
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_data_flash =
    (uint32_t *)&__tz_DATA_FLASH_N;
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_ram =
    (uint32_t *)&__tz_RAM_N;
#if BSP_FEATURE_TZ_VERSION == 2
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_callable_ram =
    (uint32_t *)&__RAM_NSC_START;
#else
BSP_DONT_REMOVE uint32_t const *const gp_start_of_nonsecure_callable_ram =
    (uint32_t *)&__tz_RAM_C;
#endif
...
void R_BSP_NonSecureEnter(void) {
  ...
  uint32_t const *p_ns_vector_table =
      (uint32_t *)((uint32_t)gp_start_of_nonsecure_flash |
                   BSP_FEATURE_TZ_NS_OFFSET);

  /* Set up the NS Reset_Handler to be called */
  uint32_t const *p_ns_reset_address =
      (uint32_t const *)((uint32_t)p_ns_vector_table + sizeof(uint32_t));
  bsp_nonsecure_func_t p_ns_reset = (bsp_nonsecure_func_t)(*p_ns_reset_address);

#if BSP_TZ_CFG_NON_SECURE_APPLICATION_FALLBACK

  /* Check if the NS application exists. If the address of the Reset_Handler is
   * all '1's, then assume that the NS application has not been programmed.
   *
   * If the secure application attempts to jump to an invalid instruction, a
   * HardFault will occur. If the MCU is in NSECSD state, then the debugger will
   * be unable to connect and program the NS Application. Jumping to a valid
   * instruction ensures that the debugger will be able to connect.
   */
  if (UINT32_MAX == *p_ns_reset_address) {
    p_ns_reset = (bsp_nonsecure_func_t)((uint32_t)gp_start_of_nonsecure_ram |
                                        BSP_FEATURE_TZ_NS_OFFSET);

    /* Write an infinite loop into start of NS RAM (Branch T3 Instruction (b.n
     * <gp_start_of_nonsecure_ram>)). */
    uint16_t *infinite_loop = (uint16_t *)((uint32_t)gp_start_of_nonsecure_ram |
                                           BSP_FEATURE_TZ_NS_OFFSET);
...
void R_BSP_SecurityInit(void) {
  ...
  uint32_t itcm_block_size =
      ((MEMSYSCTL->ITGU_CFG & MEMSYSCTL_ITGU_CFG_BLKSZ_Msk) >>
       MEMSYSCTL_ITGU_CFG_BLKSZ_Pos) +
      5U;

  /* The number of secure ITCM blocks is equal to size of the secure region in
   * bytes divided by the ITCM block size. */
  uint32_t itcm_num_sec_blocks = ((uint32_t)gp_start_of_nonsecure_itcm -
                                  (uint32_t)gp_start_of_secure_itcm) >>
                                 itcm_block_size;
  ...
  uint32_t dtcm_block_size =
      ((MEMSYSCTL->DTGU_CFG & MEMSYSCTL_DTGU_CFG_BLKSZ_Msk) >>
       MEMSYSCTL_DTGU_CFG_BLKSZ_Pos) +
      5U;

  /* The number of secure DTCM blocks is equal to size of the secure region in
   * bytes divided by the DTCM block size. */
  uint32_t dtcm_num_sec_blocks = ((uint32_t)gp_start_of_nonsecure_dtcm -
                                  (uint32_t)gp_start_of_secure_dtcm) >>
                                 dtcm_block_size;
  ...
  R_CPSCU->SRAMSABAR0 =
      (uint32_t)gp_start_of_nonsecure_ram & R_CPSCU_SRAMSABAR0_SRAMSABAR_Msk;
  R_CPSCU->SRAMSABAR1 =
      (uint32_t)gp_start_of_nonsecure_ram & R_CPSCU_SRAMSABAR1_SRAMSABAR_Msk;

  /* Configure SAU region used for Code Flash Non-secure callable. */
  SAU->RNR = BSP_SAU_REGION_CODE_FLASH_NSC;
  SAU->RBAR =
      (uint32_t)gp_start_of_nonsecure_callable_flash & SAU_RBAR_BADDR_Msk;
  SAU->RLAR =
      (((uint32_t)gp_start_of_nonsecure_flash - 1U) & SAU_RLAR_LADDR_Msk) |
  ...
  SAU->RBAR =
      (uint32_t)BSP_PRV_SAU_NS_REGION_1_BASE_ADDRESS & SAU_RBAR_BADDR_Msk;
  SAU->RLAR = ((BSP_PRV_SAU_NS_REGION_1_LIMIT_ADDRESS)&SAU_RLAR_LADDR_Msk) |
              SAU_RLAR_ENABLE_Msk;
  ...
  SAU->RLAR =
      (((uint32_t)gp_start_of_nonsecure_ram - 1U) & SAU_RLAR_LADDR_Msk) |
      SAU_RLAR_NSC_Msk | SAU_RLAR_ENABLE_Msk;
  ...
  SAU->RBAR =
      ((uint32_t)BSP_PRV_SAU_NS_REGION_2_BASE_ADDRESS & SAU_RBAR_BADDR_Msk) |
      BSP_FEATURE_TZ_NS_OFFSET;
  ...
  SAU->RLAR = (BSP_PRV_SAU_NS_REGION_3_LIMIT_ADDRESS & SAU_RLAR_LADDR_Msk) |
              SAU_RLAR_ENABLE_Msk;

  /* Enable the SAU. */
  SAU->CTRL = SAU_CTRL_ENABLE_Msk;

  /* Cache maintenance is required when changing security attribution of an
   * address. Barrier instructions are required to guarantee intended operation
   * (See Arm Cortex-M85 Technical Reference Manual Section 10.9.3). */
  SCB_InvalidateICache();
#else

  /* Setting SAU_CTRL.ALLNS to 1 allows the security attribution of all
   * addresses to be set by the IDAU in the system. */
  SAU->CTRL = SAU_CTRL_ALLNS_Msk;
#endif

  /* The following section of code to configure SCB->AIRCR, SCB->NSACR, and
   * FPU->FPCCR is taken from system_ARMCM33.c in the CMSIS_5 repository.
   * SCB->SCR SLEEPDEEPS bit is not configured because the SCB->SCR SLEEPDEEP
   * bit is ignored on RA MCUs. */
#if defined(SCB_CSR_AIRCR_INIT) && (SCB_CSR_AIRCR_INIT == 1U)

  /* Configure whether non-secure projects have access to system reset, whether
   * bus fault, hard fault, and NMI target secure or non-secure, and whether
   * non-secure interrupt priorities are reduced to the lowest 8 priority
   * levels. */
  SCB->AIRCR =
  ...
  /* Configure whether FPU registers are always treated as non-secure (and
   * therefore not preserved on the stack when switching from secure to
   * non-secure), and whether the FPU registers should be cleared on exception
   * return. */
  ...
  R_SYSTEM->DPFSAR = BSP_TZ_CFG_DPFSAR; /* Deep Standby Interrupt Factor
                                           Security Attribution. */
#ifdef BSP_TZ_CFG_RSCSAR
  R_SYSTEM->RSCSAR =
      BSP_TZ_CFG_RSCSAR; /* RAM Standby Control Security Attribution. */
#endif
#ifdef BSP_TZ_CFG_PGCSAR
  R_SYSTEM->PGCSAR =
      BSP_TZ_CFG_PGCSAR; /* Power Gating Control Security Attribution. */
#endif
#ifdef BSP_TZ_CFG_BBFSAR
  R_SYSTEM->BBFSAR =
      BSP_TZ_CFG_BBFSAR; /* Battery Backup Security Attribution. */
#endif
  R_CPSCU->ICUSARA =
      BSP_TZ_CFG_ICUSARA; /* External IRQ Security Attribution. */
  R_CPSCU->ICUSARB = BSP_TZ_CFG_ICUSARB; /* NMI Security Attribution. */
#ifdef BSP_TZ_CFG_ICUSARC
  R_CPSCU->ICUSARC =
      BSP_TZ_CFG_ICUSARC; /* DMAC Channel Security Attribution. */
#endif
#ifdef BSP_TZ_CFG_DMACCHSAR
  R_CPSCU->DMACCHSAR =
      BSP_TZ_CFG_DMACCHSAR; /* DMAC Channel Security Attribution. */
#endif
  ...
  R_ELC->ELCSARA =
      BSP_TZ_CFG_ELCSARA; /* ELCR, ELSEGR0, ELSEGR1 Security Attribution. */
#endif
  ...
  R_CPSCU->STBRAMSAR =
      BSP_TZ_CFG_STBRAMSAR; /* Standby RAM Security Attribution. */
#endif
  R_CPSCU->MMPUSARA = BSP_TZ_CFG_MMPUSARA; /* Security Attribution for the DMAC
                                              Bus Master MPU. */
  R_CPSCU->BUSSARA = BSP_TZ_CFG_BUSSARA; /* Security Attribution Register A for
                                            the BUS Control Registers. */
  R_CPSCU->BUSSARB = BSP_TZ_CFG_BUSSARB; /* Security Attribution Register B for
                                            the BUS Control Registers. */

#if (defined(BSP_TZ_CFG_ICUSARC) && (BSP_TZ_CFG_ICUSARC != UINT32_MAX)) || \
    (defined(BSP_TZ_CFG_DMACCHSAR) &&                                      \
     ((BSP_TZ_CFG_DMACCHSAR & R_CPSCU_DMACCHSAR_DMACCHSARn_Msk) !=         \
  ...
  /* On MCUs with this implementation of trustzone, DMAST security attribution
   * is set to secure after reset. */
#else

  /* If any DMAC channels are required by secure program, disable nonsecure
   * write access to DMAST in order to prevent the nonsecure program from
   * disabling all DMAC channels. */
  ...
  /* On MCUs with this implementation of trustzone, DMACSAR security attribution
   * is set to secure after reset. If the DMAC is not used in the secure
   * application,then configure DMAST security attribution to non-secure. */
  R_CPSCU->DMACSAR = 1U;
#endif
  ...
  /* On MCUs with this implementation of trustzone, DTCST security attribution
   * is set to secure after reset. */
#else

  /* If the DTC is used by the secure program, disable nonsecure write access to
   * DTCST in order to prevent the nonsecure program from disabling all DTC
   * transfers. */
  R_CPSCU->DTCSAR = ~1U;
#endif
  ...
  /* On MCUs with this implementation of trustzone, DTCST security attribution
   * is set to secure after reset. If the DTC is not used in the secure
   * application,then configure DTCST security attribution to non-secure. */
  R_CPSCU->DTCSAR = 1U;
#endif
