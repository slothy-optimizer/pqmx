...
/** The main oscillator drive value is based upon the oscillator frequency
 * selected in the configuration */
#define CGC_MOMCR_RESERVED_MASK \
  (0x8U) /* RA8 has reserved bit in MOMCR that must be 1. */
...
#define BSP_FEATURE_ACMPHS_MIN_WAIT_TIME_US \
  (1U)  // This comes from the Electrical Characteristics in the hardware
        // manual. Rounding up to nearest microsecond.
#define BSP_FEATURE_ACMPHS_VREF (ACMPHS_REFERENCE_IVREF2)

#define BSP_FEATURE_ACMPLP_HAS_COMPSEL_REGISTERS \
  (0U)  // Feature not available on this MCU
#define BSP_FEATURE_ACMPLP_MIN_WAIT_TIME_US \
  (0U)  // Feature not available on this MCU

#define BSP_FEATURE_ADC_ADDITION_SUPPORTED (1U)  // ADC Derived from RA8M1
#define BSP_FEATURE_ADC_B_TSN_CALIBRATION32_MASK \
  (0)                                    // Feature not available on this MCU
#define BSP_FEATURE_ADC_B_TSN_SLOPE (0)  // Feature not available on this MCU
#define BSP_FEATURE_ADC_B_UNIT_0_CHANNELS \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_ADC_B_UNIT_1_CHANNELS \
  (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS \
  (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_ADC_TSN_CALIBRATION_AVAILABLE \
  (1U)  // TSCDR is a 32-bit register on this MCU
...
#define BSP_FEATURE_AGT_USE_AGTIOSEL_ALT \
  (0)  // Indicates use of AGTIOSEL_ALT instead of AGTIOSEL
...
#define BSP_FEATURE_BSP_HAS_GPT_CLOCK \
  (0U)  // Mutually exclusive with USB60 Clock
...
#define BSP_FEATURE_BSP_HAS_USB60_CLOCK_REQ \
  (1U)  // Feature available on this MCU
...
#define BSP_FEATURE_BSP_MPU_REGION0_MASK \
  (0U)  // Feature not available on this MCU
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5_MAX_CH \
  (0U)  // If MSTPRE is present than the setting is not valid.
#define BSP_FEATURE_BSP_MSTP_HAS_MSTPCRE (1U)
#define BSP_FEATURE_BSP_NUM_PMSAR \
  (16U)  // 16 due to offset address change from PMSAR2 to PMSAR3
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_FIVE_ROM_WAITS \
  (240000000U)  // The maximum frequency allowed without having five ROM wait
                // cycles (Set to zero if this is not an option).
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_FOUR_ROM_WAITS \
  (192000000U)  // The maximum frequency allowed without having four ROM wait
                // cycles (Set to zero if this is not an option).
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_NO_RAM_WAITS (120000000U)
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_ONE_ROM_WAITS \
  (48000000U)  // The maximum frequency allowed without having one ROM wait
               // cycle.
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_THREE_ROM_WAITS \
  (144000000U)  // The maximum frequency allowed without having three ROM wait
                // cycles (Set to zero if this is not an option).
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_TWO_ROM_WAITS \
  (96000000U)  // The maximum frequency allowed without having two ROM wait
               // cycles. (Set to zero if this is not an option).
...
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2 \
  (0U)  // On the RA8M1 there is another register to enable write access for
        // SRAMWTSC.
...
#define BSP_FEATURE_CGC_LOW_SPEED_MAX_FREQ_HZ \
  (1000000U)  // This MCU does have Low Speed Mode, up to 1MHz
#define BSP_FEATURE_CGC_LOW_VOLTAGE_MAX_FREQ_HZ \
  (0U)  // This MCU does not have Low Voltage Mode
#define BSP_FEATURE_CGC_MIDDLE_SPEED_MAX_FREQ_HZ \
  (0U)  // This MCU does not have Middle Speed Mode
...
#define BSP_FEATURE_CGC_PLLCCR_WAIT_US \
  (0U)  // No wait between setting PLLCCR and clearing PLLSTP
...
#define BSP_FEATURE_CTSU_CTSUCHAC_REGISTER_COUNT \
  (0U)  // Feature not available on this MCU
#define BSP_FEATURE_CTSU_CTSUCHTRC_REGISTER_COUNT \
  (0U)                                   // Feature not available on this MCU
...
#define BSP_FEATURE_DAC8_HAS_CHARGEPUMP \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_DAC8_HAS_DA_AD_SYNCHRONIZE \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_DAC8_HAS_REALTIME_MODE \
  (0)                                      // Feature not available on this MCU
...
#define BSP_FEATURE_DWT_CYCCNT \
  (1U)  // RA8M1 has Data Watchpoint Cycle Count Register

#define BSP_FEATURE_ELC_PERIPHERAL_MASK \
  (0x4003FFFFU)  // Deprecated (Removing in FSP v6.0)
#define BSP_FEATURE_ELC_VERSION (2U)

#define BSP_FEATURE_ETHER_FIFO_DEPTH (0x0000070FU)
#define BSP_FEATURE_ETHER_MAX_CHANNELS (1U)
#define BSP_FEATURE_ETHER_SUPPORTS_TZ_SECURE \
  (1U)  // Feature available on this MCU
...
#define BSP_FEATURE_FLASH_LP_AWS_FAW_MASK \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_AWS_FAW_SHIFT \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_CF_BLOCK_SIZE \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_CF_WRITE_SIZE \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_DF_BLOCK_SIZE \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_DF_WRITE_SIZE \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_FLASH_CLOCK_SRC \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_SUPPORTS_DUAL_BANK \
  (0)                                     // Feature not available on this MCU
#define BSP_FEATURE_FLASH_LP_VERSION (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_SUPPORTS_ACCESS_WINDOW \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_FLASH_SUPPORTS_ID_CODE \
  (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK \
  (BSP_FEATURE_GPT_VALID_CHANNEL_MASK)
...
#define BSP_FEATURE_GPT_ODC_VALID_CHANNEL_MASK \
  (0U)  // Feature not available on this MCU
...
#define BSP_FEATURE_ICU_WUPEN_MASK \
  (0x00007F08FF1DFFFFU)  // Note there is another WUPEN1 register
...
#define BSP_FEATURE_LPM_HAS_HOCO_STARTUP_SPEED_MODE \
  (0U)  // Feature not available on this MCU
#define BSP_FEATURE_LPM_HAS_STANDBY_SOSC_SELECT \
  (0U)  // Feature not available on this MCU
#define BSP_FEATURE_LPM_HAS_FLASH_MODE_SELECT \
  (0U)  // Feature not available on this MCU
#define BSP_FEATURE_LPM_SNOOZE_REQUEST_DTCST_DTCST \
  (0U)  // Feature not available on this MCU
...
#define BSP_FEATURE_LVD_MONITOR_1_STABILIZATION_TIME_US \
  (20U)  // LVD1 operation stabilization time after LVD1 is enabled
#define BSP_FEATURE_LVD_MONITOR_2_STABILIZATION_TIME_US \
  (20U)  // LVD2 operation stabilization time after LVD2 is enabled
...
#define BSP_FEATURE_OPAMP_HAS_MIDDLE_SPEED \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_OPAMP_HAS_SWITCHES (0U)
#define BSP_FEATURE_OPAMP_HAS_THIRD_CHANNEL (0U)
#define BSP_FEATURE_OPAMP_MIN_WAIT_TIME_HS_US \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_OPAMP_MIN_WAIT_TIME_LP_US \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_OPAMP_MIN_WAIT_TIME_MS_US \
  (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_SAU_UART_VALID_CHANNEL_MASK \
  (0U)  // Feature not available on this MCU
...
#define BSP_FEATURE_SDHI_MIN_CLOCK_DIVISION_SHIFT \
  (0U)  // 1 (2^0) is minimum division supported
...
#define BSP_FEATURE_SLCDC_HAS_8_TIME_SLICE \
  (0)  // Feature not available on this MCU
#define BSP_FEATURE_SLCDC_HAS_INTERNAL_VOLT_GEN \
  (0)                                      // Feature not available on this MCU
...
#define BSP_FEATURE_SLCDC_CONTRAST_MAX_4BIAS \
  (0)                                       // Feature not available on this MCU
...
#define BSP_FEATURE_TAU_CLOCK_SOURCE \
  (NULL)  // Feature not available on this MCU
#define BSP_FEATURE_TAU_VALID_CHANNEL_MASK \
  (0)  // Feature not available on this MCU

#define BSP_FEATURE_TML_MAX_CLOCK_DIVIDER \
  (0U)                                    // Feature not available on this MCU
#define BSP_FEATURE_TML_NUM_CHANNELS (0)  // Feature not available on this MCU
#define BSP_FEATURE_TML_VALID_CHANNEL_MASK \
  (0U)  // Feature not available on this MCU

#define BSP_FEATURE_TFU_SUPPORTED \
  (0U)  // Trigonometric Function Unit (TFU) available on this MCU
