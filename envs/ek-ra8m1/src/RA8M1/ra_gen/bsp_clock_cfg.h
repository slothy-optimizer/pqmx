...
#define BSP_CFG_PLL_MUL \
  BSP_CLOCKS_PLL_MUL(96, 0) /* PLL Mul x80-99|Mul x96|PLL Mul x96.00 */
...
#define BSP_CFG_PLL2_MUL \
  BSP_CLOCKS_PLL_MUL(96, 0) /* PLL2 Mul x80-99|Mul x96|PLL2 Mul x96.00 */
...
#define BSP_CFG_CLOCK_SOURCE \
  (BSP_CLOCKS_SOURCE_CLOCK_PLL1P) /* Clock Src: PLL1P */
#define BSP_CFG_CLKOUT_SOURCE                    \
  (BSP_CLOCKS_CLOCK_DISABLED) /* CLKOUT Disabled \
                               */
#define BSP_CFG_SCICLK_SOURCE                    \
  (BSP_CLOCKS_CLOCK_DISABLED) /* SCICLK Disabled \
                               */
#define BSP_CFG_SPICLK_SOURCE                    \
  (BSP_CLOCKS_CLOCK_DISABLED) /* SPICLK Disabled \
                               */
#define BSP_CFG_CANFDCLK_SOURCE \
  (BSP_CLOCKS_CLOCK_DISABLED) /* CANFDCLK Disabled */
#define BSP_CFG_I3CCLK_SOURCE                                               \
  (BSP_CLOCKS_CLOCK_DISABLED)                            /* I3CCLK Disabled \
                                                          */
...
#define BSP_CFG_OCTA_SOURCE \
  (BSP_CLOCKS_CLOCK_DISABLED) /* OCTASPICLK Disabled */
...
#define BSP_CFG_CANFDCLK_DIV \
  (BSP_CLOCKS_CANFD_CLOCK_DIV_8)                        /* CANFDCLK Div /8 */
...
#define BSP_CFG_DCACHE_ENABLED \
  (1)  /* Enable the DCACHE, see section 4.5 of Renesas application note*/
