...
typedef struct {
  ...
  __IM uint32_t
      ITREAD; /*!< Offset: 0xEF0 (R/ )  ITM Integration Read Register */
  uint32_t RESERVED4[1U];
  __OM uint32_t
      ITWRITE; /*!< Offset: 0xEF8 ( /W)  ITM Integration Write Register */
  uint32_t RESERVED5[1U];
  __IOM uint32_t
      ITCTRL; /*!< Offset: 0xF00 (R/W)  ITM Integration Mode Control Register */
...
#define ITM_ITCTRL_IME_Msk \
  (0x1UL /*<< ITM_ITCTRL_IME_Pos*/) /*!< ITM ITCTRL: IME Mask */
