...
#define MAKE_BENCH_CURVE25519_SIZEOPT(var, func)                                         \
    int bench_##var()                                                    \
    {                                                                         \
        debug_printf("curve25519_scalarmult_sizeopt Benchmark for " #func);           \
        uint64_t t2, t1;                                                      \
...
MAKE_BENCH_CURVE25519_SIZEOPT(curve25519_scalarmult_sizeopt, curve25519_scalarmult)


int main(void)
{
    debug_test_start( "curve25519_scalarmult_sizeopt new" );
    /* Test correctness */


    /* Bench */
    bench_curve25519_scalarmult_sizeopt();
