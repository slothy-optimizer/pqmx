...
#define MAKE_BENCH_CURVE448_SIZEOPT(var, func)                                         \
    int bench_##var()                                                    \
    {                                                                         \
        debug_printf("curve448_scalarmult_sizeopt Benchmark for " #func);           \
        uint64_t t2, t1;                                                      \
...
MAKE_BENCH_CURVE448_SIZEOPT(curve448_scalarmult_sizeopt, curve448_scalarmult)
...
int main(void)
{
    debug_test_start( "curve448_scalarmult_sizeopt new" );
    /* Test correctness */


    /* Bench */
    bench_curve448_scalarmult_sizeopt();
