...
extern void curve448_scalarmult(void*);
...
#define MAKE_BENCH_CURVE448_SPEEDOPT(var, func)                                         \
    int bench_##var()                                                    \
    {                                                                         \
        debug_printf("curve448_scalarmult_speedopt Benchmark for " #func);           \
        uint64_t t2, t1;                                                      \
...
MAKE_BENCH_CURVE448_SPEEDOPT(curve448_scalarmult_speedopt, curve448_scalarmult)
...
int main(void)
{
    debug_test_start( "curve448_scalarmult_speedopt new" );
    /* Test correctness */


    /* Bench */
    bench_curve448_scalarmult_speedopt();
