...
.macro    KeccakRound0
        ...
        eor r11, r9, r7, ror #0          // ...............*.........................................................................................
        ldr r7, [r0, #Ase1]              // .............*...........................................................................................
        eor r3, r11, r12, ror #0         // ................*........................................................................................
        str r2, [r13, #mDi0]             // ............................................................................*............................
        eor r2, r3, r7, ror #0           // .................*.......................................................................................
        eor r11, r10, r2, ror #31        // ..................*......................................................................................
        str r6, [r13, #mDo1]             // ...................................*.....................................................................
        eor r6, r2, r4                   // ........................................*................................................................
        str r11, [r13, #mDa0]            // ........................*................................................................................
        ...
        // ldr      r11, [r0, #Amu0]        // ......................................................................................*..................
        // ldr      r12, [r0, #Asu0]        // ........................................................................................*................
        // eor  r3, r3, r1, ror #0-0        // ...................................................................................*.....................
        // eor  r3, r3, r5, ror #0-0        // .....................................................................................*...................
        // eor  r3, r3, r11, ror #0-0       // .......................................................................................*.................
        // eor  r3, r3, r12, ror #0-0       // ..........................................................................................*..............
        // ldr   r7, [r0, #Abe1]            // ............................................................................................*............
        // ldr     r1, [r0, #Age1]          // .........................................................................................*...............
        // ldr     r5, [r0, #Ake1]          // ..............................................................................................*..........
        // ldr      r11, [r0, #Ame1]        // ...............................................................................................*.........
        // ldr      r12, [r0, #Ase1]        // .................................................................................................*.......
        // eor  r7, r7, r1, ror #0-0        // .............................................................................................*...........
        // eor  r7, r7, r5, ror #0-0        // ................................................................................................*........
        // eor  r7, r7, r11, ror #0-0       // ..................................................................................................*......
        // eor  r7, r7, r12, ror #0-0       // ....................................................................................................*....
        ...
        // ldr       r12, [r0, #Asi1]       // ..............................................................................*..........................
        // str r6, [r13, #mDa0]             // ........................................................................................................*
        // eor  r4, r4, r1, ror #0-0        // .........................................................................*...............................
        // eor  r4, r4, r5, ror #0-0        // ...........................................................................*.............................
        // eor  r4, r4, r11, ror #0-0       // .............................................................................*...........................
        // eor  r4, r4, r12, ror #0-0       // ...............................................................................*.........................
        // eor     r6, r3, r4               // ...........................................................................................*.............
        // ldr    r3, [r0, #Abo0]           // ..........*..............................................................................................
        // ldr      r1, [r0, #Ago0]         // ........*................................................................................................
        // ldr      r5, [r0, #Ako0]         // ............*............................................................................................
...
@
.align 8
.global   KeccakF1600_StatePermute_opt_m7
KeccakF1600_StatePermute_opt_m7:
