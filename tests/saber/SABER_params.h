...
/* NOTE: Modifying this is not spec-compliant, but helps the implementation.
 *       Another choice here would be storing the secret in NTT-domain. */
#if defined(USE_SECRET_KEY_8BIT_PACKING)
#define SABER_INDCPA_SECRETKEYBYTES (SABER_N * SABER_L)
#else
