.syntax unified
.type poly_u16_toom4_inv_832_mve, %function
.global poly_u16_toom4_inv_832_mve
poly_u16_toom4_inv_832_mve:
push {r4-r11,lr}
vpush {d0-d15}
add r0, r0, #504
add r14, r0, #1008
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #216]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r0, #488]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r0,#(488)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-440]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q3
vldrw.u32 Q4, [r10, #232]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r0, #504]
vadd.u16 Q7, Q7, Q3
vstrw.u32 Q7, [r0,#(504)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q3, [r11, #-424]
vmla.s16 Q6, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #248]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-488]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r14,#(-488)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-408]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q3
vldrw.u32 Q4, [r10, #264]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-472]
vadd.u16 Q7, Q7, Q3
vstrw.u32 Q7, [r14,#(-472)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q3, [r11, #-392]
vmla.s16 Q6, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #280]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-456]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r14,#(-456)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-376]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q3
vldrw.u32 Q4, [r10, #296]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-440]
vadd.u16 Q7, Q7, Q3
vstrw.u32 Q7, [r14,#(-440)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q3, [r11, #-360]
vmla.s16 Q6, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #312]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-424]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r14,#(-424)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-344]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q3
vldrw.u32 Q4, [r10, #328]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-408]
vadd.u16 Q7, Q7, Q3
vstrw.u32 Q7, [r14,#(-408)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q3, [r11, #-328]
vmla.s16 Q6, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #344]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-392]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r14,#(-392)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-312]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q3
vldrw.u32 Q4, [r10, #360]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-376]
vadd.u16 Q7, Q7, Q3
vstrw.u32 Q7, [r14,#(-376)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q3, [r11, #-296]
vmla.s16 Q6, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
vldrw.u32 Q7, [r12, #280]
vadd.u16 Q7, Q7, Q1
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #376]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-360]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r14,#(-360)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-280]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
vldrw.u32 Q7, [r12, #296]
vadd.u16 Q7, Q7, Q1
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q3
vldrw.u32 Q4, [r10, #392]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-344]
vadd.u16 Q7, Q7, Q3
vstrw.u32 Q7, [r14,#(-344)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q3, [r11, #-264]
vmla.s16 Q6, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
vldrw.u32 Q7, [r12, #312]
vadd.u16 Q7, Q7, Q1
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #408]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-328]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r14,#(-328)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-248]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
vldrw.u32 Q7, [r12, #328]
vadd.u16 Q7, Q7, Q1
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q3
vldrw.u32 Q4, [r10, #424]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-312]
vadd.u16 Q7, Q7, Q3
vstrw.u32 Q7, [r14,#(-312)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q3, [r11, #-232]
vmla.s16 Q6, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
vldrw.u32 Q7, [r12, #344]
vadd.u16 Q7, Q7, Q1
...
vadd.u16 Q1, Q1, Q1
vsub.u16 Q2, Q2, Q5
vldrw.u32 Q6, [r10, #440]
vadd.u16 Q1, Q1, Q0
vldrw.u32 Q7, [r14, #-296]
vadd.u16 Q7, Q7, Q5
vstrw.u32 Q7, [r14,#(-296)]
vmla.s16 Q1, Q2, r6
vldrw.u32 Q5, [r11, #-216]
vmla.s16 Q4, Q2, r7
vshr.u16 Q1, Q1, #3
vmul.u16 Q1, Q1, r5
vldrw.u32 Q7, [r12, #360]
vadd.u16 Q7, Q7, Q1
