#if !defined(SABER_TEST_CONFIG_DEFAULT_H)
#define SABER_TEST_CONFIG_DEFAULT_H

/* Allow forcing the config from the command line. */
...
#endif /* SABER_TEST_CONFIG_DEFAULT_H */
